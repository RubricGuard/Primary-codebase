...
const GradingWorkspace = () => {
  ...
  // Show AI highlights only for the focused criterion
  const aiHighlightedQuotes = focusedCriterion
    ? (currentScores.find((s) => s.criterionId === focusedCriterion)?.validationResult?.keyQuotes || [])
